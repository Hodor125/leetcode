package Graph_Search.Leecode51.mySolution2;
...
public class Solution {
    public List<List<String>> solveNQueens(int n) {
        ...
        dfs(ansList,position,n,0,columns,diagonal1,diagonal2);
     ...
     */
    public void dfs(List<List<String>> ansList,int[] position,int row,int curr_row,Set<Integer> columns,
        ...
        for (int i = 0; i < row; i++) {
            ...
            //进入分支，填下一行
            dfs(ansList,position,row,curr_row + 1,columns,diagonal1,diagonal2);
